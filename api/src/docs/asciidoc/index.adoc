...
=== 인터뷰 LLM 응답 상황 폴링 조회 V2 - PENDING

include::{snippetsDir}/interview-getPolling-PENDING-V2/http-request.adoc[]
include::{snippetsDir}/interview-getPolling-PENDING-V2/path-parameters.adoc[]
include::{snippetsDir}/interview-getPolling-PENDING-V2/http-response.adoc[]
include::{snippetsDir}/interview-getPolling-PENDING-V2/response-fields.adoc[]
include::{snippetsDir}/interview-getPolling-PENDING-V2/curl-request.adoc[]

=== 인터뷰 LLM 응답 상황 폴링 조회 V2 - FAILED

include::{snippetsDir}/interview-getPolling-FAILED-V2/http-request.adoc[]
include::{snippetsDir}/interview-getPolling-FAILED-V2/path-parameters.adoc[]
include::{snippetsDir}/interview-getPolling-FAILED-V2/http-response.adoc[]
include::{snippetsDir}/interview-getPolling-FAILED-V2/response-fields.adoc[]
include::{snippetsDir}/interview-getPolling-FAILED-V2/curl-request.adoc[]
