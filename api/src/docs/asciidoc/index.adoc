...
=== 인터뷰 LLM 응답 상황 폴링 조회 V2 - COMPLETED - 진행중인 인터뷰

include::{snippetsDir}/interview-getPolling-COMPLETED-IN-PROGRESS-V2/http-request.adoc[]
include::{snippetsDir}/interview-getPolling-COMPLETED-IN-PROGRESS-V2/path-parameters.adoc[]
include::{snippetsDir}/interview-getPolling-COMPLETED-IN-PROGRESS-V2/http-response.adoc[]
include::{snippetsDir}/interview-getPolling-COMPLETED-IN-PROGRESS-V2/response-fields.adoc[]
include::{snippetsDir}/interview-getPolling-COMPLETED-IN-PROGRESS-V2/curl-request.adoc[]
