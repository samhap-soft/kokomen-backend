...
public class GptSystemMessageConstant {
    ...
    protected static final String PROCEED_SYSTEM_MESSAGE = """
            ...
            - 응답 포맷 : JSON으로 응답해줘. 필드는 위에서 설명한대로 rank, feedback, next_question 이야. ObjectMapper로 파싱해야 하니까 ` 같은 건 붙이지 말아줘. 이때 피드백과 다음 질문은 존댓말로 응답해야해.
            """;
    protected static final String END_SYSTEM_MESSAGE = """
            ...
            - 태스크 : 다음 단계에 따라 면접자의 마지막 답변에 대한 피드백과 랭크를 응답해주고, 동시에 전체 면접에 대한 피드백을 응답해줘.
            ...
            - 응답 포맷 : JSON으로 응답해줘. 필드는 위에서 설명한대로 rank, feedback, total_feedback 이야. ObjectMapper로 파싱해야 하니까 ` 같은 건 붙이지 말아줘. 이때 피드백과 다음 질문은 존댓말로 응답해야해.
            """;
