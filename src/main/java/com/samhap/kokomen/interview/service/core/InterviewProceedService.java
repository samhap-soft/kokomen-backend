package com.samhap.kokomen.interview.service.core;
...
public class InterviewProceedService {
    ...
    private void evaluateInterview(QuestionAndAnswers questionAndAnswers, Answer curAnswer, Interview interview,
