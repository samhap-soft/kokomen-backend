...
=== 다른 사용자의 인터뷰 목록 조회 (로그인 버전)

include::{snippetsDir}/interview-findMemberInterviews-authenticated/http-request.adoc[]
include::{snippetsDir}/interview-findMemberInterviews-authenticated/query-parameters.adoc[]
include::{snippetsDir}/interview-findMemberInterviews-authenticated/http-response.adoc[]
include::{snippetsDir}/interview-findMemberInterviews-authenticated/response-fields.adoc[]
include::{snippetsDir}/interview-findMemberInterviews-authenticated/curl-request.adoc[]

=== 다른 사용자의 인터뷰 목록 조회 (비회원 버전)

include::{snippetsDir}/interview-findMemberInterviews-unauthenticated/http-request.adoc[]
include::{snippetsDir}/interview-findMemberInterviews-unauthenticated/query-parameters.adoc[]
include::{snippetsDir}/interview-findMemberInterviews-unauthenticated/http-response.adoc[]
include::{snippetsDir}/interview-findMemberInterviews-unauthenticated/response-fields.adoc[]
include::{snippetsDir}/interview-findMemberInterviews-unauthenticated/curl-request.adoc[]
...
=== 다른 사용자의 인터뷰 최종 결과 조회 (로그인 버전)

include::{snippetsDir}/interview-findResults-authenticated/http-request.adoc[]
include::{snippetsDir}/interview-findResults-authenticated/path-parameters.adoc[]
include::{snippetsDir}/interview-findResults-authenticated/http-response.adoc[]
include::{snippetsDir}/interview-findResults-authenticated/response-fields.adoc[]
include::{snippetsDir}/interview-findResults-authenticated/curl-request.adoc[]

=== 다른 사용자의 인터뷰 최종 결과 조회 (비회원 버전)

include::{snippetsDir}/interview-findResults-unauthenticated/http-request.adoc[]
include::{snippetsDir}/interview-findResults-unauthenticated/path-parameters.adoc[]
include::{snippetsDir}/interview-findResults-unauthenticated/http-response.adoc[]
include::{snippetsDir}/interview-findResults-unauthenticated/response-fields.adoc[]
include::{snippetsDir}/interview-findResults-unauthenticated/curl-request.adoc[]
