...
include::{snippetsDir}/member-updateNickname/http-request.adoc[]
include::{snippetsDir}/member-updateNickname/request-fields.adoc[]
include::{snippetsDir}/member-updateNickname/http-response.adoc[]
include::{snippetsDir}/member-updateNickname/curl-request.adoc[]

=== 멤버 닉네임 변경 예외

include::{snippetsDir}/member-updateNickname-error/http-request.adoc[]
include::{snippetsDir}/member-updateNickname-error/request-fields.adoc[]
include::{snippetsDir}/member-updateNickname-error/http-response.adoc[]
include::{snippetsDir}/member-updateNickname-error/curl-request.adoc[]
