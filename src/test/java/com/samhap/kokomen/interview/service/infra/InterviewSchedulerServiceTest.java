...
import com.samhap.kokomen.interview.service.social.InterviewViewCountService;
...
class InterviewSchedulerServiceTest extends BaseTest {
    ...
    void batchUpdateInterviewViewCount() {
        ...
        for (long interviewId = 1; interviewId <= interviewCount; interviewId++) {
            ...
            redisService.setIfAbsent(InterviewViewCountService.INTERVIEW_VIEW_COUNT_KEY_PREFIX + interviewId, viewCount,
                    Duration.ofDays(1));
        }
